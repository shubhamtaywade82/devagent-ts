...
import { ToolDefinition, ToolHandler } from "@nemesis-oss/nexum-core/kernel/tools/tool-definition";
...
import { extractToolCalls } from "@nemesis-oss/nexum-core/kernel/strategies/execution-strategy";
import type {
  AgentId,
  AgentRuntime,
  EventSink,
  ExecutionBudget,
  ExecutionRequest,
} from "@nemesis-oss/nexum-core/kernel/types";
import type { StrategyHooks } from "@nemesis-oss/nexum-core/kernel/strategies/strategy-hooks";
import type { Capability } from "@nemesis-oss/nexum-models/provider/catalog";
import type { ChatMessage, OllamaToolSchema } from "@nemesis-oss/nexum-models/provider/provider";
