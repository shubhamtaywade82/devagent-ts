...
import { Provider, ChatMessage, ChatOptions, ChatResponse } from "@nemesis-oss/nexum-models/provider/provider";
import { Router } from "@nemesis-oss/nexum-models/provider/router";
import { Capability, inferCapabilities, ModelCatalog } from "@nemesis-oss/nexum-models/provider/catalog";
import { CheckpointStore, sanitizeResumedSteps } from "@nemesis-oss/nexum-core/runtime/checkpoint";
...
import { LspServerState } from "@nemesis-oss/nexum-tools/lsp/protocol";
import {
  ApprovalRequest,
...
import { KeyManager } from "@nemesis-oss/nexum-models/provider/key-manager";
import { HeuristicRouter } from "@nemesis-oss/nexum-models/provider/heuristic-router";
import { LocalWorker } from "@nemesis-oss/nexum-models/provider/local-worker";
...
import { LOCAL_DELEGATION_SYSTEM_ADDENDUM } from "@nemesis-oss/nexum-tools/tools/delegate-tool";
import { detectEscalationHint, isLookupPrompt } from "./agent-escalation.js";
// ── Kernel (agent execution kernel) ───────────────────────────────────
import { ApprovalBroker, describeConfirmation } from "@nemesis-oss/nexum-core/kernel/policy/approval-broker";
import { DefaultModelGateway } from "@nemesis-oss/nexum-models/provider/default-model-gateway";
...
import type { StrategyHooks } from "@nemesis-oss/nexum-core/kernel/strategies/strategy-hooks";
...
export class Agent {
  ...
  constructor(opts: AgentOptions = {}) {
    ...
    this.intelligence = new AgentIntelligence({
      ...
      lspConfig: cfg.lsp as import("@nemesis-oss/nexum-tools/lsp/config").LspGlobalConfig | undefined,
