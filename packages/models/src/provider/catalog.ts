...
import type { Capability, ModelInfo } from "@nemesis-oss/nexum-core/kernel/model-types";
export type { Capability, ModelInfo } from "@nemesis-oss/nexum-core/kernel/model-types";
