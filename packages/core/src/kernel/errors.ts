/**
 * Agent-runtime error vocabulary (moved verbatim from provider/errors.ts
 * during the package split so the kernel and every other plane can share
 * one error taxonomy without importing the model implementations).
 * provider/errors.ts re-exports these names.
 */
