/**
 * LoopDetector — repeated-failure loop breaker (moved verbatim from
 * orchestrator/loop-detector.ts during the package split; the kernel's
 * strategies use it and must not import the product plane).
 * orchestrator/loop-detector.ts re-exports this class.
 */
