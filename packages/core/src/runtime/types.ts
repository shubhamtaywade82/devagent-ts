...
// ── Control-plane step vocabulary (moved from orchestrator/types.ts during
// the package split so runtime events/checkpoints never import the product
// plane; orchestrator/types.ts re-exports these) ──
