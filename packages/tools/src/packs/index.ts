...
import { ToolPack, ToolPackEntry, packOf } from "@nemesis-oss/nexum-core/kernel/tools/tool-pack";
import type { ToolRisk } from "@nemesis-oss/nexum-core/kernel/tools/tool-definition";
