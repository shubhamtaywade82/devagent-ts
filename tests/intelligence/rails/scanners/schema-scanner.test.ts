import { SchemaScanner } from "@nemesis-oss/nexum-tools/intelligence/rails/scanners/schema-scanner";
import { TableEntity } from "@nemesis-oss/nexum-tools/intelligence/rails/types";
