import { RoutesScanner } from "@nemesis-oss/nexum-tools/intelligence/rails/scanners/routes-scanner";
import { RouteEntity } from "@nemesis-oss/nexum-tools/intelligence/rails/types";
