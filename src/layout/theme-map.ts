/**
 * Compat shim over the Nexum theme registry (src/tui/ui/theme-registry.ts).
 *
 ...
 *
 * New components should prefer `useTheme()` from src/tui/ui/ and consume the
 * full token set; this module exists for the legacy non-React call sites.
 */

import { ActorHealth, ThemeName } from "../runtime/types.js";
import { getTheme } from "../tui/ui/theme-registry.js";
import type { Theme } from "../tui/ui/types.js";
